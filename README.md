...
Icônes fixes bleus: ```yaml: /local/community/lovelace-meteofrance-weather-card/icons_1/ ```:

Icônes fixes blancs: ```yaml: /local/community/lovelace-meteofrance-weather-card/icons_2/ ```:

Icônes animées blancs: ```yaml: /local/community/lovelace-meteofrance-weather-card/icons_3/ ```:
